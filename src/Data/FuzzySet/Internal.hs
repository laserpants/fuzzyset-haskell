...
-- a set for potential matches and determining how similar a search string is to
-- the entries of the set. The key idea is to translate strings to vectors and
...
-- denotes the euclidean norm, or /magnitude/, of \(A\).
--
...
matches
    :: FuzzySet
    -> HashMap Text Int
    -- ^ A sparse vector representation of the ..., generated by 'gramVector'
    -> HashMap Int Int

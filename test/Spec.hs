...
main = hspec $ do
    ...
    checkGramMap "bananasananas" 2 [("-b", 1), ("ba", 1), ("an", 4), ("na", 4), ("as", 2), ("sa", 1), ("s-", 1)]
    checkGramMap "bananasananas" 3 [("-ba", 1), ("ban", 1), ("ana", 4), ("nan", 2), ("nas", 2), ("asa", 1), ("san", 1), ("as-", 1)]
...
--
 --   describe "matches (testset_1 ^._matchDict) (gramMap \"ant\" 3)" $ do
 --     it "should return fromList [(0, 1), (1, 2), (2, 1), (3, 1)]" $
 --       matches (testset_1 ^._matchDict) (gramMap "ant" 3)
 --         `shouldBe` fromList [(0, 1), (1, 2), (2, 1), (3, 1)]
--
 --   describe "matches (testset_1 ^._matchDict) (gramMap \"pant\" 3)" $ do
 --     it "should return fromList [(0, 1), (1, 2), (2, 1), (3, 2)]" $
 --       matches (testset_1 ^._matchDict) (gramMap "pant" 3)
 --         `shouldBe` fromList [(0, 1), (1, 2), (2, 1), (3, 2)]
--
 --   describe "matches (testset_1 ^._matchDict) (gramMap \"pants\" 3)" $ do
 --     it "should return fromList [(1, 1), (3, 4)]" $
 --       matches (testset_1 ^._matchDict) (gramMap "pants" 3)
 --         `shouldBe` fromList [(1, 1), (3, 4)]
--
 --   describe "matches (testset_1 ^._matchDict) (gramMap \"tre\" 3)" $ do
 --     it "should return fromList [(0, 2)]" $
 --       matches (testset_1 ^._matchDict) (gramMap "tre" 3)
 --         `shouldBe` fromList [(0, 2)]
--
 --   describe "matches (testset_1 ^._matchDict) (gramMap \"xxx\" 3)" $ do
 --     it "should return empty" $
 --       matches (testset_1 ^._matchDict) (gramMap "xxx" 3) `shouldBe` empty
--
 --   describe "matches (testset_1 ^._matchDict) (gramMap \"xxx\" 2)" $ do
 --     it "should return empty" $
 --       matches (testset_1 ^._matchDict) (gramMap "xxx" 2) `shouldBe` empty
